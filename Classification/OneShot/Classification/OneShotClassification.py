...
def run_model(ms_info, model_name, ms_file_name, feature_reduce_choice):
    X = ms_info['X']
    y = ms_info['y']
...
def get_results(model_name, ms_input_file, feature_reduce_choice, transpose_select):
    output_dir = os.path.join(current_working_dir, 'output')
    ...
    results = run_model(ms_info, the_model, ms_file_name, feature_reduce_choice)
...
def main(ms_input_file, feature_reduce_choice):
    ...
    results, ms_info = get_results(model_name, ms_input_file, feature_reduce_choice, transpose_select)
    ms_file_name = Path(ms_input_file).stem
